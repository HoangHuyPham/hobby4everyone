          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className='border-r border-gray-700 '>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link to="/guide" className="hover:text-blue-300">New Customer Guide</Link></li>
                <li><Link to="/shipping" className="hover:text-blue-300">Shipping Methods</Link></li>
                <li><Link to="/payment" className="hover:text-blue-300">Payment Methods</Link></li>
                <li><Link to="/status" className="hover:text-blue-300">Stock Status</Link></li>
            ...
            <div className='border-r border-gray-700'>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/warehouse" className="hover:text-blue-300">Private Warehouse</Link></li>
                <li><Link to="/account" className="hover:text-blue-300">Account Details</Link></li>
                <li><Link to="/orders" className="hover:text-blue-300">Order History</Link></li>
                <li><Link to="/payment-method" className="hover:text-blue-300">Payment Method</Link></li>
                <li><Link to="/profile" className="hover:text-blue-300">Corporate Profile</Link></li>
              </ul>
            </div>
